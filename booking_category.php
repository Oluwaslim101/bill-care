...
$query = "SELECT * FROM booking_categories ORDER BY id ASC";
$stmt = $sql->prepare($query);
$stmt->execute();
...
<div id="appCapsule">
   ...
   <div class="container mt-1 px-2 pb-3">
    <div class="row gy-2">
        ...
        $category_links = [
            'Hotel' => 'hotel_index.php',
            'Event' => 'book_event.php',
            'Ride' => 'car_rental.php',
            'Flight' => 'book_flight.php',
            'Logistics' => 'book_logistics.php'
        ];
        ...
        ?>
            <div class="col-4 text-center">
                <a href="<?= $category_links[$cat_name] ?? '#' ?>">
                    <div class="user-card">
                        <i class="fa <?= $icon_map[$cat_name] ?? 'fa-circle' ?>" style="font-size: 30px; color: #007bff;"></i>

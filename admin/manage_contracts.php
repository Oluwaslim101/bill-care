...
<div id="appCapsule">
    <div class="section mt-2 mb-2">
       ...
       <h2>Add New Contract</h2>
        <form action="manage_contracts.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" name="amount_invested" id="amount_invested" class="form-control" required>
            </div>
            ...
            <tbody>
                <?php foreach ($contracts as $contract): ?>
                    <tr>
                        ...
                        <td>
                            <a href="manage_contracts.php?edit_id=<?php echo $contract['id']; ?>" class="btn btn-warning">Edit</a>
                            <a href="manage_contracts.php?delete_id=<?php echo $contract['id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this contract?');">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
